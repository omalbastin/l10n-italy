...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/8.0/account_vat_period_end_statement/static/description/icon.png
...
``run_odoo_debug 8.0 -um account_vat_period_end_statement -s -d MYDB``
