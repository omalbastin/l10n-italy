...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/8.0/l10n_it_ateco/static/description/icon.png
...
| MODULE_DIR is module directory, currently is: l10n_it_ateco
...
``run_odoo_debug 8.0 -um l10n_it_ateco -s -d MYDB``
