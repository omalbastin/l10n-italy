...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/8.0/l10n_it_ddt_delivery/static/description/icon.png
...
| MODULE_DIR is module directory, currently is: l10n_it_ddt_delivery
...
|menu| Setting > Local Modules |right_do| Select **l10n_it_ddt_delivery** > Install

|warning| If your Odoo instance crashes, you can do following instruction
to recover installation status:

``run_odoo_debug 8.0 -um l10n_it_ddt_delivery -s -d MYDB``
