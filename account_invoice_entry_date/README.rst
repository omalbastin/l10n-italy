...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/8.0/account_invoice_entry_date/static/description/icon.png
...
| MODULE_DIR is module directory, currently is: account_invoice_entry_date
...
``run_odoo_debug 8.0 -um account_invoice_entry_date -s -d MYDB``
