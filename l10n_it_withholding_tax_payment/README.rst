...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/8.0/l10n_it_withholding_tax_payment/static/description/icon.png

======================================
|icon| Italian Withholding Tax Payment
======================================
...
| MODULE_DIR is module directory, currently is: l10n_it_withholding_tax_payment
...
|menu| Setting > Local Modules |right_do| Select **l10n_it_withholding_tax_payment** > Install

|warning| If your Odoo instance crashes, you can do following instruction
to recover installation status:

``run_odoo_debug 8.0 -um l10n_it_withholding_tax_payment -s -d MYDB``
