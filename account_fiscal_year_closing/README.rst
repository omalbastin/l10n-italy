...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/8.0/account_fiscal_year_closing/static/description/icon.png
...
| MODULE_DIR is module directory, currently is: account_fiscal_year_closing
...
``run_odoo_debug 8.0 -um account_fiscal_year_closing -s -d MYDB``
